...
\begin{figure}[!ht]
        \makebox[\textwidth][c]{\includegraphics[width=1\linewidth]{Esercizio3_img/Es3-setting3SYS.pdf}}
...
\newpage
\begin{figure}[!ht]
        \makebox[\textwidth][c]{\includegraphics[width=1.4\linewidth]{Esercizio3_img/Es3-setting3DG.pdf}}
