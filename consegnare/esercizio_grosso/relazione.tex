...
\newpage
\subsubsection{RG}
Il reachability graph, in figura \ref{FIG:3.2RG}, è composto da 16 stati raggiungibili e non presenta alcun deadlock.
\begin{figure*}[!ht]
\centering
\makebox[\textwidth][c]{
...
%TODO: decommentare, le due immagini sono sul portatile.
%\begin{figure*}[!ht]
%\centering
%\makebox[\textwidth][c]{
%\includegraphics[width=1\textwidth]{3_2Eq}}
...
\begin{itemize}
	...
	\item assenza di starvation: \textit{G F ( \#Q2 ==1 ) -> (G F (\#Q3==1) -> G F(\#Q8 == 1))} E la proposizione corrispondente per Q risultano \textcolor{green}{true}.\\
Un modo di imporre una computazione fair è garantire il progresso del processo opposto a quello di cui si vuole verificare l'assenza di starvation. La proposizione \textit{G F ( \#Q2 ==1 )} ad esempio garantisce che il proceso \textit{Q} uscirà dalla sezione criticà. In tal modo però i processi sono obbligati al progresso in sezione non critica.
...
\section{Confronto}
Come si può notare dalla seguente tabella non è presente alcuna differenza tra le implementazioni effettuate con GreatSPN e le implementazioni in NuSMV.
\begin{center}
\makebox[\textwidth][c]{
